  ...
  def __init__(self):
    ...
    self.parser.add_argument('--vis_corner', type=int, default=0,
                             help='vis corner or not'
                                  '0: do not vis corner'
                                  '1: vis corner')
    self.parser.add_argument('--convert_onnx', type=int, default=1,
    ...
    self.parser.add_argument('--demo_name', default='demo_results', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--output_dir', default='/mnt/user/zxy/LORE-TSR/data/table', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')   
    self.parser.add_argument('--demo_dir', default='/mnt/user/zxy/LORE-TSR/data/test_results', 
    ...
    self.parser.add_argument('--wiz_4ps',default=True)
    self.parser.add_argument('--wiz_stacking',default=True)
    ...
    self.parser.add_argument('--nms', default=False)
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    self.parser.add_argument('--wiz_rev',default=True)
    self.parser.add_argument('--wiz_detect',  default=False)
    ...
    self.parser.add_argument('--s', default=1)
    self.parser.add_argument('--filepath', default=1)
