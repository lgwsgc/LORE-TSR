  ...
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='./demo_wtw/', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--demo_name', default='/', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    ...
    self.parser.add_argument('--load_model', default=r'/ssdata/user/zxy/code/lore/LORE-TSR/model/ckpt_wireless/model_best.pth',
                             help='path to pretrained model')
    self.parser.add_argument('--load_processor', default=r'/ssdata/user/zxy/code/lore/LORE-TSR/model/ckpt_wireless/processor_best.pth', 
