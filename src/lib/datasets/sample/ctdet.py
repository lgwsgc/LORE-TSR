...
class CTDetDataset(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    if self.opt.dataset_name == 'TG24K':
      ...
      name =os.path.splitext(img_path)
      img_path = name[0]+".jpg"
    ...
    for k in range(num_objs):
      ...
      seg_mask1 = ann['segmentation'][1]
      seg_mask2 = ann['segmentation'][2]
      seg_mask3 = ann['segmentation'][3]

      x1,y1 = seg_mask[0],seg_mask[1]
      x2,y2 = seg_mask1[0],seg_mask1[1]
      x3,y3 = seg_mask2[0],seg_mask2[1]
      x4,y4 = seg_mask3[0],seg_mask3[1]
